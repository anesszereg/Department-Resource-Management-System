...
<div class="container">
    <div class="profile-card">
        ...
        <h1 class="form-title">Profile Management</h1>

        <div class="tabs">
            <div class="tab active" onclick="openTab('profile')">Personal Information</div>
        ...
        <div id="profile-tab" class="tab-content active">
            <form method="POST">
                ...
                <div class="buttons-container">
                    <a href="profile_chef.php" class="back-button"><i class="fas fa-arrow-left"></i> Back</a>
                    <button type="submit"><i class="fas fa-save"></i> To update</button>
                </div>
            </form>
        </div>
